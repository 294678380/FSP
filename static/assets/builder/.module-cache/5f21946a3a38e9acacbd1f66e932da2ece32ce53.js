...
window.SearchBox = React.createClass({displayName: "SearchBox",
	...
	submit:function(event){
		if(!$(event.target).hasClass("not_search")){
			$(event.target).addClass("not_search");
			self.props.callback(self.refs["search_text"],function(){
				$(event.target).removeClass("not_search")
			});
		}
