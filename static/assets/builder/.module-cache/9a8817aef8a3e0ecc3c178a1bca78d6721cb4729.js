	...
	render:function(){
		return React.createElement("div", {ref: "restful_test", className: "restful_test none"}, 
					React.createElement("pre", null, 
						...
						React.createElement("p", null, " url:\"http://localhost:8090/api/v1/streams/add/test2\","), 
						React.createElement("p", null, " async:true,"), 
						React.createElement("p", null, " dataType:\"json\","), 
						React.createElement("p", null, " data:{"), 
						React.createElement("p", null, "  key:\"ISMvKXpXpadDiUoOSoAfww\","), 
						React.createElement("p", null, "  field:\"body\","), 
						React.createElement("p", null, "  value:\"test\""), 
						React.createElement("p", null, " },"), 
						React.createElement("p", null, " success:function(res){"), 
						React.createElement("p", null, "  console.log(res);"), 
						React.createElement("p", null, " }"), 
						React.createElement("p", null, "});")
					)
			   )
