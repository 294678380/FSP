									...
									React.createElement("div", {className: "heading"}, 
										React.createElement("a", {className: "logo", href: this.props.home}, 
											...
											React.createElement("div", {className: "header-right"}, 
													...
													React.createElement("a", {id: "signOut", href: this.props.signOut}, "登录")
												)
...
window.SearchBox = React.createClass({displayName: "SearchBox",
	render:function(){
		return React.createElement("div", {className: "sjl-line searchbox"}, 
						React.createElement("input", {className: "sjl_input", type: "text", placeholder: "数据流名称"}), 
						React.createElement("input", {className: "sjl-submit", type: "button", title: "搜索", value: ""})
					)
	}
})
//chackbox
...
function tr(tr,index){
	if(tr.length == 0){
		return React.createElement("div", {className: "tr"}, 
					React.createElement("div", {className: "td", key: key, style: item.style})
				)
	}
...
window.Loading = React.createClass({displayName: "Loading",
	...
	render:function(){
		return React.createElement("div", null, 
						...
						this.props.isShow==1?React.createElement("div", {className: "loading"}, 
